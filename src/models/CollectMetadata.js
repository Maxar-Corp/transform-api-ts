...
exports.CollectMetadataToJSON = exports.CollectMetadataFromJSONTyped = exports.CollectMetadataFromJSON = exports.instanceOfCollectMetadata = void 0;
 ...
 */
function instanceOfCollectMetadata(value) {
    let isInstance = true;
    isInstance = isInstance && "imageBoundsWGS84" in value;
    return isInstance;
}
exports.instanceOfCollectMetadata = instanceOfCollectMetadata;
function CollectMetadataFromJSON(json) {
    return CollectMetadataFromJSONTyped(json, false);
}
exports.CollectMetadataFromJSON = CollectMetadataFromJSON;
function CollectMetadataFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CollectMetadataFromJSONTyped = CollectMetadataFromJSONTyped;
function CollectMetadataToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CollectMetadataToJSON = CollectMetadataToJSON;
